...
const Login: React.FC = () => {
    ...
    const [lang, setLang] = useState<string>(RNLocalize.getLocales()[0].languageCode);
    ...
    try {
      ...
      if (error?.response?.status === 400) {
        ...
        Alert.alert(
          t('Hata'),
          t(
            'Bilinmeyen hata meydana geldi. Lütfen sistem yöneticinizle konuşunuz',
          ),
        );
      }
    }
    ...
    <SafeAreaView style={styles.root}>
        ...
        <TouchableOpacity
          ...
          {lang === 'tr' ? (
            <>
              ...
              <Text style={{marginLeft: 4}}>Türkçe</Text>
            </>
          ) : (
            <>
              <Image source={en} style={{width: 20, height: 16}} />
              <Text style={{marginLeft: 4}}>English</Text>
            </>
          )}
        </TouchableOpacity>
      </View>
      <View
        ...
        <View
          style={{
            width: '90%',
            backgroundColor: 'rgba(208, 85, 21, 0.2)',
            height: 1,
            marginTop: 25,
          }}></View>
        <TouchableOpacity
          ...
          style={{marginTop: 15}}>
          <Text style={{color: '#D05515', fontSize: 16}}>
            {t('kayitli_degilim')}
          </Text>
        </TouchableOpacity>
      </View>
